...
const Profile = () => {
  ...
  return (
                    ...
                    <div className="md:flex no-wrap md:-mx-2 ">
                        ...
                        <div className="w-full md:w-3/12 md:mx-2">
                            ...
                            <div className="bg-white p-3 border-t-4 border-yellow-400 rounded-xl">
                                ...
                                <h1 className="text-gray-900 font-bold text-xl leading-8 my-1 mt-3">{pmcDetails.pmc.name}</h1>
    ...
    <span>PMCDetails</span>
</div>
<div className="py-2">
    <div className="text-gray-700 text-sm">
        <div className="py-1">
            <span className="font-semibold">CEO/Owner Name:</span> Rajiv Perera
        </div>
        <div className="py-1">
            <span className="font-semibold">Key Personnel:</span> Sanjeewa Kumar (CFO), Sumedha Dias (CTO)
        </div>
        
        <div className="py-1">
            <span className="font-semibold">Operational Regions:</span> Colombo
        </div>
    </div>
</div>
    ...
    <div className="text-gray-700">
        <div className="grid md:grid-cols-2 text-sm">
            <div className="grid grid-cols-2">
                ...
                <div className="px-4 py-2 font-bold text-sm">{pmcDetails.pmc.name}</div>
            </div>
            <div className="grid grid-cols-2">
                <div className="px-4 py-2 ">Registration Number</div>
                <div className="px-4 py-2 font-bold text-sm">{pmcDetails.pmc.regno}</div>
            </div>
            <div className="grid grid-cols-2">
                <div className="px-4 py-2 ">Email</div>
                <div className="px-4 py-2 font-bold text-sm">{pmcDetails.user.email}</div>
            </div>
            <div className="grid grid-cols-2">
                <div className="px-4 py-2 ">Contact No.</div>
                <div className="px-4 py-2 font-bold text-sm">0115 234 987</div>
            </div>
            <div className="grid grid-cols-2">
                <div className="px-4 py-2 ">Current Address</div>
                <div className="px-4 py-2 font-bold text-sm">{pmcDetails.user.addressno}, {pmcDetails.user.street_1}, {pmcDetails.user.street_2}, {pmcDetails.user.city}</div>
            </div>
            <div className="grid grid-cols-2">
                <div className="px-4 py-2 ">District</div>
                <div className="px-4 py-2 font-bold text-sm">{pmcDetails.user.province}</div>
            </div>
        </div>
    </div>
</div>
...
<div className="bg-white p-3 shadow-sm rounded-xl">
    ...
    <div className="grid grid-cols-1 gap-4 p-4">
        <div className="bg-white p-2 rounded-lg shadow-md">
            <h2 className="font-semibold mb-2">Licenses and Certifications</h2>
